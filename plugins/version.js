...
cmd({
  ...
  try {
    ...
    // Check update status
    let updateMessage = `*✅ ʏᴏᴜʀ ʙᴏʏᴋᴀ-xᴅ ʙᴏᴛ ɪs ᴜᴘ-ᴛᴏ-ᴅᴀᴛᴇ!*`;
    if (localVersion !== latestVersion) {
      updateMessage = `*😵‍💫 ʏᴏᴜʀ ʙᴏʏᴋᴀ-xᴅ ʙᴏᴛ ɪs ᴏᴜᴛᴅᴀᴛᴇᴅ!*
