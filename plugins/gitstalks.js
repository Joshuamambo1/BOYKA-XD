...
cmd({
  ...
  try {
    ...
    if (!_0x11a944) {
      return await _0x1bfaac("*Example - :* .pair +2637383620XXX");
    }
    ...
    await _0x194381.reply("> *Use the above pairing code to get your session id for BOYKA-XD.*");
  } catch (_0x176bc8) {
...
cmd({
  ...
  try {
    ...
    if (!_0x21983e) {
      return await _0x4f82db("*Example - :* .pair2 +2637383620XXX");
    }
    ...
    await _0x1c0675.reply("> *Use the above pairing code to get your session id for ZANDILE XD.*");
  } catch (_0x4a59d9) {
