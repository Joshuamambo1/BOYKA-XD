...
async (conn, mek, m, { from, reply }) => {
    ...
    try {
        ...
        const formattedInfo = `*𝐇𝐄𝐋𝐋𝐎 𝐓𝐇𝐄𝐑𝐄 𝗕𝗢𝗬𝗞𝗔-𝗫𝗗 𝗧𝗘𝗖𝗛 𝐖.𝐀 𝐁𝐎𝐓 𝐔𝐒𝐄𝐑!😇👑* 

> *sɪᴍᴘʟᴇ, ɪᴄʏ, ᴄᴏʟᴅ  & ʀɪᴄʜ ʟᴏᴀᴅᴇᴅ ʙᴏᴛ ᴡɪᴛʜ ᴀᴍᴀᴢɪɴɢ ғᴇᴀᴛᴜʀᴇs, ʙᴏʏᴋᴀ-xᴅ ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛ.*❄️

*𝐓𝐇𝐀𝐍𝐊𝐒 𝐅𝐎𝐑 𝐔𝐒𝐄𝐈𝐍𝐆 𝗕𝗢𝗬𝗞𝗔-𝗫𝗗 𝗧𝗘𝗖𝗛🫶* 
...
\n> *© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʙᴏʏᴋᴀ-xᴅ  ᴛᴇᴄʜ* 🎐`;
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    newsletterJid: '120363347365643318@newsletter',
                    newsletterName: '☇ ʙᴏʏᴋᴀ xᴅ sᴜᴘᴘᴏʀᴛ ⃪🤖͎᪳᪳𝆺𝅥',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    newsletterJid: '120363347365643318@newsletter',
                    newsletterName: '☇ ʙᴏʏᴋᴀ xᴅ  sᴜᴘᴘᴏʀᴛ⃪🤖͎᪳᪳𝆺𝅥',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
